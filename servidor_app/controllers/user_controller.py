...
def perfil():
    ...
    return render_template('user/perfil.html', user=current_user, dados_servidor=dados_servidor)
...
def configuracoes():
    if request.method == 'POST':
        ...
        if not current_user.check_password(current_password):
            ...
            return redirect(url_for('user.configuracoes'))
    ...
    dados_servidor = get_server_info(current_app.config['ROOT_DIR'])
    return render_template('main/configuracoes.html', user=current_user, dados_servidor=dados_servidor)
